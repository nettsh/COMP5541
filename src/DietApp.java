...
public class DietApp {
    ...
    public static void main(String[] args) {
        ...
        InDining inDiningItem = new InDining("003", "2020-01-02 1:00AM", "Rice", "200g","Carb");
        OutDining outDiningItem = new OutDining("004","2020-02-02 2:00PM","Second Cup","Cookies", "Main Dish");
